'''Использовано 87 % доступного пространства. … Когда место закончится, вы не сможете создавать, редактировать и загружать файлы. Получите 100 ГБ за 139,00 ₽ 35,00 ₽/мес. на 3 месяца.
